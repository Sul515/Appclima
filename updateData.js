...
// Aquí deberías poner tu clave de API obtenida desde OpenWeatherMap
const apiKey = '697a5193e0278184ea94c96534eb72b9'; //  tu API key
const cities = [
    ...
    for (let city of cities) {
        try {
            ...
            weatherData[city] = {
                ...
                date: formattedDate,
                humidity: data.main.humidity,  // Agregar humedad
